...
/obj/item/weapon/tool/weldingtool/electric/examine(mob/user, distance)
	. = ..()
	if (!cell)
...
/obj/item/weapon/tool/weldingtool/electric/afterattack(var/obj/O, var/mob/user, var/proximity)
...
/obj/item/weapon/tool/weldingtool/electric/get_cell()
	if(cell)
		. = cell
...
/obj/item/weapon/tool/weldingtool/electric/get_fuel()
	return get_available_charge()

/obj/item/weapon/tool/weldingtool/electric/proc/get_available_charge()
	var/obj/item/weapon/cell/cell = get_cell()
	return cell ? cell.charge : 0

/obj/item/weapon/tool/weldingtool/electric/attackby(var/obj/item/W, var/mob/user)
...
/obj/item/weapon/tool/weldingtool/electric/burn_fuel(var/amount)
...
/obj/item/weapon/tool/weldingtool/electric/proc/spend_charge(var/amount)
	var/obj/item/weapon/cell/cell = get_cell()
	if(cell)
