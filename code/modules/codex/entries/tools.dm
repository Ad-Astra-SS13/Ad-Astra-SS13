/datum/codex_entry/wrench
	associated_paths = list(/obj/item/weapon/tool/wrench)
...
/datum/codex_entry/screwdriver
	associated_paths = list(/obj/item/weapon/tool/screwdriver)
...
/datum/codex_entry/wirecutters
	associated_paths = list(/obj/item/weapon/tool/wirecutters)
...
/datum/codex_entry/welder
	associated_paths = list(/obj/item/weapon/tool/weldingtool)
...
/datum/codex_entry/crowbar
	associated_paths = list(/obj/item/weapon/tool/crowbar)
